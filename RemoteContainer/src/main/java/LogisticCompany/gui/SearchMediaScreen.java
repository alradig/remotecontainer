...
public class SearchMediaScreen {
	...
	private JList<MediumInfo> listSearchResult;
	private DefaultListModel<MediumInfo> searchResults;
			...
			public void valueChanged(ListSelectionEvent e) {
		        if (e.getValueIsAdjusting() == false) {
		            ...
		            if (listSearchResult.getSelectedIndex() == -1) {
		            	...
		            	lblSearchResultDetail.setText(new MediumPrinter(listSearchResult.getSelectedValue()).printDetail());
		            }
		        }
			}
		});
